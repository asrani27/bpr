...
<div class="row">
  <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header">
          <i class="ion ion-clipboard"></i><h3 class="box-title">Pencairan Perorangan</h3>
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form method="get" action="/superadmin/laporan/perorangan" target="_blank">
            @csrf
            Masukkan Nomor Deposito
...
<div class="row">
  <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header">
          <i class="ion ion-clipboard"></i><h3 class="box-title">Mutasi Deposito</h3>
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form method="get" action="/superadmin/laporan/mutasi" target="_blank">
            @csrf
            Masukkan Nomor Deposito
            <input type="text" class="form-control" name="nomor">
            <button type="submit" class="btn btn-primary btn-sm">Print</button>
